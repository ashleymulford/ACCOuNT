'''
Uses VCF b37 anno and dosage input files to add b37 rsids to dosage file. Needed for use with predixcan transcript models
'''
...
def check_arg(args=None):
    ...
    parser.add_argument('-a', '--anno)vcf',
                        help='full path to anno VCF file',
                        required='True'
                        )
    parser.add_argument('-i', '--inputdir',
                        help='directory containing dosage file',
                        required='True'
                        )
